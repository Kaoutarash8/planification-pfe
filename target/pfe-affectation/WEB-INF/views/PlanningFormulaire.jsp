...
<head>
    ...
    <title>Générer Planning - ENSA Al Hoceima</title>
...
<body>
    <div class="loading-overlay" id="loadingOverlay">
        <div class="loading-spinner">
            ...
            <p class="mt-2">Génération du planning en cours...</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="form-container">
                <div class="form-title">
                    <i class="fas fa-calendar-alt me-2"></i>Générer le Planning
                </div>
                <div class="form-subtitle">
                    Téléchargez le fichier de configuration et le fichier des professeurs
                </div>
                
                <div class="info-box">
                    <i class="fas fa-info-circle me-2"></i>
                    <strong>Prérequis :</strong> L'affectation des encadrants doit avoir été générée au préalable.
                </div>
                
                <form id="planningForm" action="${pageContext.request.contextPath}/affectation" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="action" value="genererPlanning">
                    
                    <!-- Upload Configuration -->
                    <div class="mb-4">
                        <label class="form-label fw-bold mb-2">
                            <i class="fas fa-file-alt me-1" style="color:#0033a0;"></i> 
                        ...
                        <div class="upload-area" id="uploadAreaConfig">
                            ...
                            <p class="upload-text">
                                ...
                                Format: .xlsx | Colonnes: Paramètre, Valeur
                            </p>
                            <input type="file" id="fichierConfiguration" name="fichierConfiguration" class="d-none" accept=".xlsx">
                    ...
                    <button type="submit" class="btn-generer" id="btnGenerer">
                        <i class="fas fa-calendar-check me-2"></i> Générer le Planning
                    </button>
                </form>
    ...
    <script>
        // Setup upload areas
        const uploadAreaConfig = document.getElementById('uploadAreaConfig');
        const inputConfig = document.getElementById('fichierConfiguration');
        const fileInfoConfig = document.getElementById('fileInfoConfig');
        ...
        setupUploadArea(uploadAreaConfig, inputConfig, fileInfoConfig);
        ...
        document.getElementById('planningForm').addEventListener('submit', function(e) {
            const configFile = document.getElementById('fichierConfiguration').files[0];
            const professeursFile = document.getElementById('fichierProfesseurs').files[0];
            
            if (!configFile) {
                e.preventDefault();
                alert('Veuillez sélectionner le fichier de configuration');
                return;
            }
