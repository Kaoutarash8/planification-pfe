...
<%
    // Recuperer le chemin d'upload depuis Tomcat (via ServletContext)
    String uploadPath = application.getRealPath("/uploads");
    
    // Fallback si getRealPath retourne null (certains serveurs)
    if (uploadPath == null || !new File(uploadPath).exists()) {
        String catalinaBase = System.getProperty("catalina.base");
        if (catalinaBase != null) {
            String contextPath = application.getContextPath().replace("/", "");
            uploadPath = catalinaBase + File.separator + "webapps" + 
                         File.separator + contextPath + File.separator + "uploads";
        } else {
            // Dernier recours: dossier temporaire
            uploadPath = System.getProperty("java.io.tmpdir") + File.separator + "pfe_uploads";
        }
    }
    ...
    if (uploadDir.exists()) {
        ...
        if (fichiers != null) {
            ...
            for (File f : fichiers) {
                ...
                // Recuperer UNIQUEMENT les fichiers affectation_* et planning_*
                if ((nom.startsWith("affectation_") || nom.startsWith("planning_")) && nom.endsWith(".xlsx")) {
                    ...
                    if (nom.startsWith("affectation_")) {
                        info.put("type", "Affectation");
                    } else if (nom.startsWith("planning_")) {
                        info.put("type", "Planning");
                    }
                    
                    // Extraire l'annee: affectation_2025_2026.xlsx -> 2025_2026
                    String annee = nom.replaceAll("[^0-9_]", "").replaceAll("^_|_$", "");
                    if (annee.isEmpty()) {
                        annee = "recent";
                    }
    ...
    // Limiter aux 5 plus recents pour l'affichage
        ...
        <div class="header-content">
            <div class="logo">
                ...
                <div class="logo-text">
                    ...
                    <p>Ecole Nationale des Sciences Appliquees</p>
                </div>
            </div>
            <nav class="nav-menu">
                ...
                <a href="${pageContext.request.contextPath}/planning" class="${param.page == 'planning' ? 'active' : ''}">
                    <i class="bi bi-calendar-week"></i> Planning
                </a>
                <a href="${pageContext.request.contextPath}/pvs" class="${param.page == 'pvs' ? 'active' : ''}">
                ...
                <div class="historique-wrapper">
                    ...
                    <div class="historique-dropdown" id="historiqueDropdown">
                        ...
                        <div class="dropdown-header">
                            <i class="bi bi-clock-history"></i> Dernieres generations
                            <a href="${pageContext.request.contextPath}/historique" class="ms-auto" style="color:white; font-size:0.7rem;">Voir tout</a>
                        </div>
                        <% if (cinqRecents.isEmpty()) { %>
