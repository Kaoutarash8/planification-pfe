...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-pv">
                        ...
                        <p class="text-muted">
                            <c:out value="${sessionScope.fichiersPV != null ? sessionScope.fichiersPV.size() : 0}"/> encadrants
                        </p>
            ...
            <div class="info-text">
                <i class="bi bi-folder2-open me-1"></i> Les fichiers sont organisés par dossier : uploads/pvs/[Nom Encadrant]/
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function afficherListeEncadrants() {
            ...
            for (var i = 0; i < encadrants.length; i++) {
                var selectedClass = (encadrantSelectionne === encadrants[i].nom) ? 'style="background:#e8f0fe; border-left-color:#0033a0;"' : '';
                html += '<div class="encadrant-option" data-nom="' + encodeURIComponent(encadrants[i].nom) + '" ' + selectedClass + 
                        ' onclick="selectionnerEncadrant(\'' + encodeURIComponent(encadrants[i].nom) + '\', this)">';
