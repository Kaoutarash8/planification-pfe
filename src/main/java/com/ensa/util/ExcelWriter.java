...
public class ExcelWriter {
    ...
    public static String sauvegarderExcel(Affectation affectation) throws Exception {
        ...
        // Annee universitaire dynamique
        Calendar cal = Calendar.getInstance();
        int anneeActuelle = cal.get(Calendar.YEAR);
        int anneePrecedente = anneeActuelle - 1;
        String anneeUniversitaire = anneePrecedente + "/" + anneeActuelle;
        
        // Nom de fichier dynamique avec l'année universitaire
        String nomFichier = "affectation_" + anneePrecedente + "_" + anneeActuelle + ".xlsx";
        String absolutePath = uploadPath + File.separator + nomFichier;
        
        // Extraire toutes les filieres uniques
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            // Calculer le nombre max d'etudiants
            ...
            // ==================== LIGNE 3: ANNEE UNIVERSITAIRE ====================
            Row anneeRow = sheet.createRow(3);
            Cell anneeCell = anneeRow.createCell(0);
            anneeCell.setCellValue("Annee Universitaire : " + anneeUniversitaire);
            ...
            // Remplir les donnees du tableau
            ...
            for (Map.Entry<Professeur, List<Etudiant>> entry : affectation.getAffectations().entrySet()) {
                ...
                // Etudiants - chaque cellule coloree individuellement selon sa filiere
