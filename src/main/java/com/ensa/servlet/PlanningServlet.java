    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            if (config.getNbJours() <= 0) {
                // Compter le nombre total d'etudiants dans l'affectation
                ...
                // Calculer la capacite par jour
                int capaciteParJour = config.calculerCapaciteParJour();
                
                // Calculer le nombre de jours necessaires
                int joursNecessaires = (int) Math.ceil((double) totalEtudiants / capaciteParJour);
                
                // Ajouter une marge de securite (10%)
                joursNecessaires = (int) Math.ceil(joursNecessaires * 1.1);
                
                // Minimum 1 jour, maximum 10 jours
                ...
                System.out.println("  (avec marge de securite)");
            }
